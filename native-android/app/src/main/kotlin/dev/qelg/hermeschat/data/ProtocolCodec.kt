...
object ProtocolCodec {
    ...
    fun request(id: String, method: String, params: Map<String, JsonElement> = emptyMap()): JsonObject = buildJsonObject {
        put("jsonrpc", "2.0")
        put("id", id)
        put("method", method)
    ...
    fun event(frame: String): GatewayEvent? {
        val root = runCatching { json.parseToJsonElement(frame).jsonObject }.getOrNull() ?: return null
...
data class GatewayEvent(val type: String, val sessionId: String?, val payload: Map<String, JsonElement>)
